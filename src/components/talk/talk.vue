    ...
    <div class="cont">
      <ul>
        <div class="ls clf" v-for="(item, index) in msglist" :key="index">
          <div
            class="img"
            :style="{ float: item.type == 'client' ? 'left' : 'right' }"
          >
            <i
              class="iconfont"
              :class="
          ...
          <li
            :style="{
              float: item.type == 'client' ? 'left' : 'right',
              backgroundColor: item.type == 'client' ? '#1a2a3a' : 'gold',
              color: item.type == 'client' ? 'white' : '#1a2a3a'
            }"
          >
            {{ item.msg }}
          </li>
