<template>
  <div>
    <t-header :l="true" :t="'代 理 说 明'"></t-header>
    <div class="img">
      <img
        src="https://images.imags-google.com//system/mobile/other/agentIntro.jpg"
        alt=""
      />
    </div>
    <div data-v-5d5c2272 class="article-body agent-content">
      <div data-v-5d5c2272 class="font-s14">
        当您能看到这个页面，说明您的账号即是玩家账号也是代理账号，即可以自己投注，也可以发展下级玩家，赚取返点佣金。
      </div>
      <div data-v-5d5c2272 class="title">
        <hr />
        <i data-v-5d5c2272 class="van-icon"
          ><span class="iconfont">&#xe667;</span></i
        >如何赚取返点？
      </div>
      <p data-v-5d5c2272>
        可获得的返点，等于自身返点与下级返点的差值，如自身返点5，下级返点3，你将能获得下级投注金额2%的返点，如下级投注100元，你将会获得2元。
      </p>
      <p data-v-5d5c2272 class="no-b">
